...
class ArticleDataTest(TestCase):
    ...
    #     self.article1 = dict(hero=self.hero_name, title='Achilles', order='1', document='1.md')
    #     self.article2 = dict(hero=self.hero_name, title='Agamememnon', order='2', document='2.md')
    ...
    def test_article_list(self):
        Article.objects.create(**self.article1)
        Article.objects.create(**self.article2)
        b = Article.objects.filter(Hero=self.hero_title).order_by('order')
